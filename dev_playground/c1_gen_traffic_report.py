...
excel_doc.create_sheet(c1_shared.excel_doc_sheet_inbound_identified_title, ['src_ip', 'src_hostname', 'src_role', 'src_application', 'src_environment', 'src_location',
...
for record in all_records:
    ...
    if src_workload is not None:
        ...
        if is_core_service:
            ...
            excel_doc.add_line_from_object(data, c1_shared.excel_doc_sheet_inbound_identified_title)
...
excel_doc.create_sheet(c1_shared.excel_doc_sheet_outbound_identified_title, ['src_ip', 'src_hostname', 'src_role', 'src_application', 'src_environment', 'src_location',
                                                                  'dst_ip', 'dst_hostname', 'dst_role', 'dst_application', 'dst_environment', 'dst_location',
                                                                   'dst_port', 'count', 'last_seen', 'first_seen',
                                                                  'process_name', 'username', 'to_be_implemented'],
                       force_all_wrap_text=False)
...
for record in all_records:
    ...
    if dst_workload is not None:
        ...
        if is_core_service:
            ...
            excel_doc.add_line_from_object(data, c1_shared.excel_doc_sheet_outbound_identified_title)
